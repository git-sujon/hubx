...
const Shop = () => {
  ...
  return (
    <section class=" py-20 container px-[70px] mx-auto">
      <div className="">
      ...
      <Link to='/shop' className="flex justify-center mt-14">
        <button class="w-full px-6 py-4 mt-1 text-base font-semibold tracking-wide  uppercase transition-none border border-slate-500  hover:text-white   hover:bg-sky-900 sm:mt-0 sm:w-auto sm:flex-shrink-0 rajdhani-font">
          view all products
        </button>
      </Link>
    </section>
